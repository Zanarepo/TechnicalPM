        ...
        <div style={styles.container}>
            ...
            <div style={styles.content}>
                ...
                <div style={styles.userRow}>
                    ...
                    <div>
                        <strong>Alice Admin</strong> (Admin)
                        <div style={styles.cred}>
                            User: <code>Alice Admin</code><br />
                ...
                <div style={styles.userRow}>
                    <div style={styles.icon}>👷</div>
                    <div>
                        <strong>Bob Builder</strong> (Customer)
                        <div style={styles.cred}>
                            User: <code>Bob Builder</code><br />
                            Pass: <code>password123</code>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ marginTop: '10px', fontSize: '0.8rem', color: '#888', fontStyle: 'italic' }}>
                    *For Module 6 Security, you can also use your own signed-up users.
                </div>
            </div>
        </div>
    );
